...
<body>
    <div class="container">
        ...
        <p><b>{{ $email }}</b></p>
        <p>Password anda sudah berhasil di rubah<br>silahkan login kembali</p>
        <a href="{{ $url }}" class="button">Back to login</a>
        <div class="footer-text">
            Jika sudah mengklik tombol back to login<br>diarahkan ke halaman login
        </div>
    </div>
    <div class="footer">
