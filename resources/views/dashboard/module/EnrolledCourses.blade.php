                                                        ...
                                                        <div class="rbt-card variation-01 rbt-hover">
                                                            <div class="rbt-card-img">
                                                                <a href="course-details.html">
                                                                    <img src="assets/images/course/course-online-0{{ $loop->index + 1 }}.jpg"
                                                                        alt="Card image">
                                                                </a>
                                                            </div>
                                                            <div class="rbt-card-body">
                                                                ...
                                                                <ul class="rbt-meta">
                                                                    <li><i
                                                                            class="feather-book"></i>{{ [20, 10, 14][$loop->index] }}
                                                                        Lessons</li>
                                                                    <li><i
                                                                            class="feather-users"></i>{{ [40, 30, 26][$loop->index] }}
                                                                        Students</li>
                                                                </ul>
                                                                <div class="rbt-progress-style-1 mb--20 mt--10">
                                                                    <div class="single-progress">
                                                                        ...
                                                                        <div class="progress">
                                                                            ...
                                                                            <span
                                                                                class="rbt-title-style-2 progress-number">{{ $progress }}%</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
