...
@section('content')
    <div class="rbt-banner-area rbt-banner-2 variation-02 ptb--80 ptb_md--60 ptb_sm--40">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-10 text-center">
                    <div class="content">
                        ...
                        <div class="slider-btn rbt-button-group justify-content-center mt--30">
    ...
    <div class="rbt-section-gap ptb--50 ptb_md--40 ptb_sm--30">
        <div class="container">
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center mb--30">
                    ...
                    <div class="rbt-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title">
                                <a href="{{ route('Dashboard.DetailCourseDashboard') }}">Matematika Kelas 12 Private
                                    Class</a>
                            </h4>
                            <ul class="rbt-meta">
                            ...
                            <div class="rbt-card-bottom">
                                ...
                                <a class="rbt-btn-link" href="{{ route('landing.Authentication') }}">
                                    Daftar <i class="feather-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Mentoring Project Section -->
    <div class="rbt-section-gap bg-color-white ptb--50 ptb_md--40 ptb_sm--30">
        <div class="container">
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center mb--30">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="rbt-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title">
                                <a href="{{ route('landing.Authentication') }}">Fullstack Web Mentoring</a>
                            </h4>
                            <ul class="rbt-meta">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="rbt-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('landing.Authentication') }}">Machine Learning
                                    Mentoring</a></h4>
                            <ul class="rbt-meta">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="rbt-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="{{ route('landing.Authentication') }}">UI/UX Project
                                    Mentoring</a></h4>
                            <ul class="rbt-meta">
                                            ...
                                            <div class="col-12">
                                                <div>
                                                    <select
                                                        ...
                                                        <option value="" selected disabled class="option-bg">--
