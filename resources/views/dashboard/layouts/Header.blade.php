                     ...
                     <div class="header-info">
                         ...
                         <div class="logo d-none logo-light">
                             <a href="{{ route('Dashboard.Home') }}">
                                 ...
                                 <img src="{{ asset('assets/images/logo/logo-light.png') }}"
                                     alt="Education Logo Images">
                             </a>
                         </div>
                     </div>
                     ...
                     <nav class="mainmenu-nav">
                         <ul class="mainmenu">
                                         ...
                                         <div class="row row--15 single-dropdown-menu-presentation">
                                             ...
                                             <div class="col-lg-4 col-xxl-4 single-mega-item">
                                                 ...
                                                 <ul class="mega-menu-item">
                                                     <li><a href="#">Software
                                                             Development
                                                             (Fullstack) <span class="rbt-badge-card">Hot</span></a>
                                                     </li>
                                             ...
                                             <div class="col-lg-4 col-xxl-4 single-mega-item">
                                                 ...
                                                 <ul class="mega-menu-item">
                                                     <li><a href="#">Content Creation
                                                             &
                                                             Personal Branding <span
                                                                 class="rbt-badge-card">Hot</span></a></li>
                                                     <li><a href="#">Public Speaking &
                                                             Communication</a></li>
                                                     ...
                                                     <li><a href="#">Productivity &
                                                             Time
                                                             Management <span class="rbt-badge-card">New</span></a>
                                                     </li>
                                                 </ul>
                                             </div>
                             ...
                             <li class="has-dropdown has-menu-child-item">
                                 ...
                                 <ul class="submenu">
                                     <li><a href="{{ route('Dashboard.AboutUs') }}">Who We Are</a></li>
                                     <li><a href="#">Testimonials</a>
                                     <li><a href="{{ route('Dashboard.MyCommunity') }}">My Community</a></li>
                                     <li><a href="#">FAQs</a></li>
                                 </ul>
                             </li>
                         </ul>
                     ...
                     <ul class="submenu">
                         <li class="has-dropdown"><a href="#">Instructor Dashboard</a>
                             <ul class="submenu">
                                 ...
                                 <li><a href="{{ route('Dashboard.Learning') }}">My Course</a></li>
         ...
         <div class="rbt-minicart-footer">
             ...
             <div class="rbt-minicart-bottom mt--20">
                 <div class="view-cart-btn">
                     <a class="rbt-btn btn-border icon-hover w-100 text-center" href="{{ route('Dashboard.Cart') }}">
