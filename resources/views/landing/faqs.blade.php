            ...
            <div class="row g-5 align-items-center">
                                ...
                                <div class="accordion-item card">
                                    ...
                                    <div id="collapseTwo2" class="accordion-collapse collapse" aria-labelledby="headingTwo2" data-bs-parent="#accordionExampleb2">
                                        <div class="accordion-body card-body">
                                            ...
                                            us with sending mail to <a href="mailto:rainbowit10@gmail.com">rainbowit10@gmail.com</a>.
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="thumbnail rbt-image-gallery-1 mb--80 text-end">
                        <img class="image-1 rbt-radius" data-parallax='{"x": 0, "y": 30}' src="assets/images/about/about-01.jpg" alt="Education Images">
                        <img class="image-2 rbt-radius" data-parallax='{"x": 0, "y": 80}' src="assets/images/about/about-10.jpg" alt="Education Images">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rbt-accordion-area accordion-style-1 bg-color-extra2 rbt-section-gap">
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="thumbnail rbt-image-gallery-1 mb--80 text-end">
                        <img class="image-1 rbt-radius" data-parallax='{"x": 0, "y": 30}' src="assets/images/about/about-03.jpg" alt="Education Images">
                        <img class="image-2 rbt-radius" data-parallax='{"x": 0, "y": 80}' src="assets/images/about/about-11.jpg" alt="Education Images">
                    </div>
                </div>
            </div>
        </div>
