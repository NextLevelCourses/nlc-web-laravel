        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:12px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.15);border:none">
                <div class="modal-header" style="background:#f8f9fa;border-bottom:1px solid #eee;padding:20px 25px">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="background-size:60%"></button>
                </div>
                <div class="modal-body" style="padding:25px">
                    <div class="text-center mb-4">
                        <svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="color:#6c757d">
