...
@section('content')
<!-- Banner Area -->
<div class="rbt-banner-area rbt-banner-8 variation-02 ptb--140">
    <div class="container">
                    ...
                    <h1 class="title mb--10">
                        <span class="cd-headline clip is-full-width">
                            <span class="cd-words-wrapper">
                                <b class="is-visible theme-gradient">Learn. Build. Scale.</b>
                                <b class="is-hidden theme-gradient">Smart Recaps with AI</b>
                                <b class="is-hidden theme-gradient">One Platform. Endless Growth</b>
                            </span>
                        </span>
                    </h1>
                    <br>
                    <div class="rbt-counterup-area bg-color-white  pb--40">
                        <div class="container">
                            <div class="row mb--40">
                                <div class="col-lg-12">
                                    <div class="section-title text-center">
                                        ...
                                        <p class="description has-medium-font-size mt--10 mb--0">
                                            We're more than just a platform — we're a supportive space where people grow, collaborate, and build real impact together.
                                        </p>
                                    </div>
                                </div>
                            </div>
