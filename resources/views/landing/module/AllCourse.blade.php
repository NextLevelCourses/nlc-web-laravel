                        ...
                        <div class="course-grid-3">
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="{{ route('landing.DetailCourseLanding') }}">React
                                            Front To Back</a>
                                    </h4>
                        ...
                        <div class="course-grid-3">
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="{{ route('landing.DetailCourseLanding') }}">PHP
                                            Beginner Advanced</a>
                                    </h4>
                                    <ul class="rbt-meta">
                                        <li><i class="feather-book"></i>12 Lessons</li>
                                    ...
                                    <div class="rbt-card-bottom">
                                        ...
                                        <a class="rbt-btn-link left-icon"
                                            href="{{ route('landing.DetailCourseLanding') }}">Learn More<i
                            ...
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a
                                            href="{{ route('landing.DetailCourseLanding') }}">Angular Zero to Mastery</a>
                                    </h4>
                                    <ul class="rbt-meta">
                        ...
                        <div class="course-grid-3">
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="{{ route('landing.DetailCourseLanding') }}">Web
                                            Front To Back</a>
                                    </h4>
                                    <ul class="rbt-meta">
                        ...
                        <div class="course-grid-3">
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="{{ route('landing.DetailCourseLanding') }}">SQL
                                            Beginner Advanced</a>
                                    </h4>
                                    <ul class="rbt-meta">
                                        <li><i class="feather-book"></i>12 Lessons</li>
                        ...
                        <div class="course-grid-3">
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="{{ route('landing.DetailCourseLanding') }}">JS
                                            Zero to Mastery</a>
                                    </h4>
                                    <ul class="rbt-meta">
                                        <li><i class="feather-book"></i>8 Lessons</li>
