        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    ...
                    <p class="description mt--20">Find answers to common questions about our programs</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item card">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                <div class="accordion-body card-body">
                                    Pembayaran bisa dilakukan via transfer bank atau e-wallet. Setelah pembayaran dikonfirmasi, Anda akan mendapatkan akses ke kelas.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item card">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                                <div class="accordion-body card-body">
                                    Kami menawarkan garansi 7 hari uang kembali jika Anda tidak puas dengan kualitas pembelajaran setelah mengikuti sesi pertama.
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="rbt-contact-form contact-form-style-1 max-width-auto">
        ...
        <form class="max-width-auto" action="/contact" method="POST">
            ...
            <!-- Program -->
             <div class="col-12">
                <div>
                    <select class="form-select bg-white-10 border-white-20 text-white option-bg" id="program" name="program" required>
                        <option value="" selected disabled class="option-bg">-- Choose a Program --</option>
                        <option value="private-class" class="option-bg">🎯 Private Class</option>
                        <option value="corporate" class="option-bg">🏢 Mentoring Project Class</option>
                    </select>
            ...
            <!-- Message -->
            <div class="form-group">
                <textarea name="message" id="message" class="form-control pt--2" rows="4" placeholder="Write your message here..."></textarea>
            </div>
