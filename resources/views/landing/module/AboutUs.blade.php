...
@section('content')
    ...
    Mulai perjalanan belajarmu bersama Next Level Course! Pelajari berbagai materi dari dasar hingga level expert—semua disajikan dengan cara yang aplikatif, menarik, dan mudah diikuti.
                                ...
                                <div class="slider-btn rbt-button-group justify-content-center">
                                    ...
                                    <a class="rbt-btn hover-icon-reverse btn-white" href="https://www.instagram.com/nextlevelcourse_official">
                                        <span class="icon-reverse-wrapper">
    ...
    <div class="inner pl--50 pl_sm--5">
        <div class="content text-start">
            ...
            <p class="description mt--30">
                <strong>Next Level Course</strong> adalah platform pembelajaran modern yang menghubungkan guru-guru terbaik dengan masyarakat. 
                Di sini, setiap program dirancang langsung oleh para ahli dengan pendekatan yang menarik, aplikatif, dan bertujuan untuk mencerdaskan kehidupan bangsa.
            </p>
            
            <p class="description">
                Dengan beragam program kreatif dan relevan, kami hadir untuk membantu siapa saja belajar hal baru dengan cara yang mudah dan menyenangkan.
            </p>

            <div class="read-more-btn mt--40">
                <a class="rbt-btn rbt-marquee-btn radius-round btn-gradient" href="{{ route('landing.Register') }}">
